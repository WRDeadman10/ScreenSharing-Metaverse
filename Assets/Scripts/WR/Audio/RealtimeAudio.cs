...
namespace Assets.Scripts.Audio
{
    public class RealtimeAudio
    {
        ...
        private Action<float[]> _recieveaudioBytes;

        #endregion

        #region Constructor

        public RealtimeAudio(int spectrumSize, ScalingStrategy scalingStrategy, Action<float[]> receiveAudio, Action<float[]> recieveaudioBytes)
        {
            _spectrumSize = spectrumSize;
            _scalingStrategy = scalingStrategy;
            _receiveAudio = receiveAudio;
            _recieveaudioBytes = recieveaudioBytes;
        }
